...
module.exports = {
  ...
  theme: {
    colors: {
      ...
      'accent-lightest': `${tokens.color.accent[100]}`,
      'accent-lighter': `${tokens.color.accent[200]}`,
      'accent-light': `${tokens.color.accent[400]}`,
      accent: `${tokens.color.accent[500]}`,
      'accent-dark': `${tokens.color.accent[700]}`,
      'accent-darker': `${tokens.color.accent[800]}`,
      'accent-darkest': `${tokens.color.accent[900]}`,

      'negative-lighter': `${tokens.color.negative[150]}`,
      'negative-light': `${tokens.color.negative[400]}`,
      negative: `${tokens.color.negative[500]}`,
      'negative-dark': `${tokens.color.negative[600]}`,
      'negative-darker': `${tokens.color.negative[700]}`,
      'negative-darkest': `${tokens.color.negative[800]}`,

      'positive-lighter': `${tokens.color.positive[150]}`,
      'positive-Light': `${tokens.color.positive[300]}`,
      positive: `${tokens.color.positive[500]}`,
      'positive-dark': `${tokens.color.positive[600]}`,
      'positive-darker': `${tokens.color.positive[700]}`,
      'positive-darkest': `${tokens.color.positive[800]}`,
